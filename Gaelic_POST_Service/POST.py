...
englishLexicon = list(csv.reader(codecs.open(os.path.join(os.getcwd(), 'data', 'EnglishLexiconFinal06082014.csv'),'r')))
...
def tagtext_Default(inputText):
        ...
        if inputText :
                      ...
                      BrillTag = defmodel.tag(tk.tokenise(inputText))
...
def tagtext_Simplified(inputText):
        tk = GaelicTokeniser()
        algT=[]
        algV=[]
        tokenisedFile =''
        if inputText :
            ...
            BrillTag  = simmodel.tag(tk.tokenise(inputText))
